...
2. **Скрипт проверит:**
   - Наличие конфигурационных файлов (.ai_debug_config или .debug_port)
...
3. **Что делать если скрипт показывает ошибки:**
   ...
   **Ошибка: "Файл .debug_port не найден"**
...
3. **Проверьте конфигурацию:**
   ...
   ls -la .ai_debug_config .debug_port
   
   # Если .debug_port существует, проверьте порт
   cat .debug_port
   ```
...
2. **Неправильный URL в коде проб**
   - Решение: Проверьте, что `.ai_debug_config` или `.debug_port` содержат правильный URL/порт
...
[2026-01-20 08:39:07] [INFO] ============================================================
[2026-01-20 08:39:07] [INFO] Прочитан порт из .debug_port: 51234
