...
**Dependencies:** Requires 00-base-core.md, 00-base-priorities.md
...
- ❌ Публичные текстовые блоки длиннее 1 строки перед вызовом инструмента
- ❌ Публичное описание того, что ты собираешься сделать - просто делай!
...
**🚨 CRITICAL FAILURE: Публичные рассуждения и объяснения перед действием = +30 points (CRITICAL FAILURE) - выполняй действия немедленно!**
