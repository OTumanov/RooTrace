...
**Priority:** P2 (Optimization Rule)  
**Exception:** Мета-когнитивная проверка (P0) разрешена внутренне

**ЗАПРЕЩЕНО (публичные рассуждения):**
- ❌ Любые публичные рассуждения, объяснения, анализ перед действием
- ❌ "Давайте...", "Сначала...", "Теперь...", "Мне нужно...", "Я вижу...", "Я заметил..." - сразу вызывай инструменты!
- ❌ "Я буду действовать...", "Теперь я вижу...", "Теперь я должен..." - выполняй действия немедленно!
...
- ✅ Мета-когнитивная проверка (внутренне, в `<thought>` тегах) - см. `code-12-meta-cognitive.md`
- ✅ Структурированные поля формата (REASON, SUMMARY) - см. `00-base-advanced.md`
- ✅ Краткие статусы (1-2 строки): `STATUS: active`, `DATA: 5 logs`

**РАЗРЕШЕНО:**
- ✅ Только вызов инструментов БЕЗ публичных объяснений
- ✅ Краткие статусы (1-2 строки максимум): `STATUS: active`, `DATA: 5 logs`
- ✅ Ошибки в формате: `ERROR: [type]. REASON: [brief]`
- ✅ Мета-когнитивная проверка (внутренне, не публично) - см. `code-12-meta-cognitive.md`

**ШТРАФ:** Публичные рассуждения и объяснения перед действием = +30 points (CRITICAL FAILURE)
...
- ❌ **🚨 КРИТИЧЕСКИ ЗАПРЕЩЕНО:** Любые публичные рассуждения, объяснения, планы, анализ перед действием
- ❌ **🚨 КРИТИЧЕСКИ ЗАПРЕЩЕНО:** "Давайте...", "Сначала...", "Теперь...", "Мне нужно...", "Я вижу...", "Я заметил..." - выполняй действия немедленно!
- ❌ **🚨 КРИТИЧЕСКИ ЗАПРЕЩЕНО:** "Я буду действовать...", "Теперь я вижу...", "Теперь я должен...", "Я вижу, что..." - выполняй действия немедленно!
- ❌ **🚨 КРИТИЧЕСКИ ЗАПРЕЩЕНО:** Любые публичные текстовые блоки длиннее 1 строки перед вызовом инструмента
- ❌ **🚨 КРИТИЧЕСКИ ЗАПРЕЩЕНО:** Публичные reasoning блоки с длинными объяснениями - ТОЛЬКО краткий статус или сразу инструменты!
- ❌ **🚨 КРИТИЧЕСКИ ЗАПРЕЩЕНО:** Публичное описание того, что ты видишь или понимаешь - просто вызывай инструменты!
- ✅ **РАЗРЕШЕНО:** Мета-когнитивная проверка (внутренне, в `<thought>` тегах) - см. `code-12-meta-cognitive.md`
