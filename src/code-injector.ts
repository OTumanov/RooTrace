  ...
  try {
    ...
    switch (language.toLowerCase()) {
      ...
      case 'py': {
        ...
        // Сначала пытаемся python3, затем fallback на python
        ...
        try {
          ...
          if (errorOutput.includes('command not found') || errorOutput.includes('python3: command not found') || 
            ...
            try {
              ...
              // Если и python не найден, пропускаем проверку
              if (errorOutput2.includes('command not found') || errorOutput2.includes('python: command not found') || 
                ...
                // Синтаксическая ошибка при использовании python
            ...
            // Синтаксическая ошибка при использовании python3
